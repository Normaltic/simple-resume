...
type ExperienceContent = DiscoveredArray<Experience["experience"]>["contents"];

const LIST1: ExperienceContent = [
...
const payload: CareerPayload[] = [
  {
    name: "Sketchsoft",
    description:
      "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deserunt libero aspernatur deleniti eligendi. Modi nostrum illum deserunt blanditiis rem molestiae quos dolore, error neque sit maxime, aliquam, voluptatem impedit facilis.",
    experiences: [
      {
        position: "Engineer",
